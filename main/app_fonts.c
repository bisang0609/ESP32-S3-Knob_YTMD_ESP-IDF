...
{
    if (objects.title) {
        lv_obj_set_style_text_font(objects.title, &Font_UI_16, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    if (objects.artist) {
        lv_obj_set_style_text_font(objects.artist, &Font_UI_14, LV_PART_MAIN | LV_STATE_DEFAULT);
